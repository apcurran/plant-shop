...
function Product() {
    ...
    const [selectedProductExtraInfo, setSelectedProductExtraInfo] = useState({
        prodExtraInfoId: "",
        prodExtraInfoSize: null,
        prodExtraInfoPrice: null,
    });
    ...
    const selectedPriceSpan = selectedProductExtraInfo.prodExtraInfoPrice ? (
        <span className="product__content__selected-price">
            ${selectedProductExtraInfo.prodExtraInfoPrice}
        </span>
    ) : (
        <span className="product__content__selected-price">
                ...
                <div className="product__grid-wrapper">
                    ...
                    <section className="product__content">
                        <div className="product__content__heading-container">
                            <h2 className="product__content__title">
                                {productData.title}
                            </h2>
                            <p className="product__content__starting-price-para">
                                starting at{" "}
                                <span className="product__content__starting-price-para__price">
                                    ${startingPrice}
                                </span>
                            </p>
                        </div>
                            ...
                            <button
                                onClick={() =>
                                    addItemToCartHandler(
                                        selectedProductExtraInfo.prodExtraInfoId,
                                        selectedProductExtraInfo.prodExtraInfoSize,
                                        selectedProductExtraInfo.prodExtraInfoPrice,
                                    )
                                }
                        ...
                        <div className="product__content__info-article-container">
                            <article className="product__content__info-article product__content__shipping-info">
                                <h3 className="product__content__shipping-info__title">
                                    Free Shipping
                                </h3>
                                <p className="product__content__shipping-info__desc">
                                    for all orders.
                                </p>
                                <svg
                                    className="product__box-icon shipping-icon"
                            ...
                            <article className="product__content__info-article product__content__warranty-info">
                                <h3 className="product__content__warranty-info__title">
                                    One Year Warranty
                                </h3>
                                <p className="product__content__warranty-info__desc">
                                    No hassle warranty against defects.
                                </p>
                                <svg
                                    className="product__box-icon warranty-icon"
                                    xmlns="http://www.w3.org/2000/svg"
                                    height="511pt"
                                ...
                                >
                                    ...
                                    <path d="M294.21 216.691l-59.222 59.22-16.07-16.075c-5.863-5.86-15.367-5.86-21.227 0-5.863 5.863-5.863 15.367 0 21.23l26.684 26.684a14.954 14.954 0 0010.613 4.398c3.84 0 7.684-1.464 10.614-4.398l69.835-69.832c5.86-5.863 5.86-15.367 0-21.227-5.863-5.863-15.367-5.863-21.226 0zm0 0" />
                                </svg>
                            </article>
                        </div>
                    </section>
