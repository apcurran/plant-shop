...
function ShopHero({ categoryQueryText }) {
    ...
    const housePlantImgs = [
        {
            publicId:
                "evergreen-app/collections/hero/long-leaves-bg_focsfr.jpg",
            alt: "Plant with long green leaves.",
        },
        {
            publicId:
                "evergreen-app/collections/hero/purple-leaves-bg_kz8iqm.jpg",
            alt: "Bird's eye view of purple leaves.",
        },
        {
            publicId:
                "evergreen-app/collections/hero/green-leaves-bg_owspbi.jpg",
            alt: "Bird's eye view of green leaves with ridges on them.",
        },
        {
            publicId:
                "evergreen-app/collections/hero/cactus-leaves-bg_dqjlmp.jpg",
    ...
    if (categoryQueryText === "house plants") {
        ...
        outputImgs = housePlantImgs.map((img) => {
            return <ShopHeroFig key={img.publicId} img={img} />;
        });
        ...
        outputTagline = (
            <ShopHeroTaglineBox titleText="Food From Your Backyard" />
        );
        ...
        outputTagline = (
            <ShopHeroTaglineBox titleText="Create Your own Oasis" />
        );
    } else {
