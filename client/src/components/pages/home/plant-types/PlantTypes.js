...
function PlantTypes() {
    return (
        <section className="home__plant-types">
            <div className="home__plant-types__left-column">
                <h2 className="home__plant-types__title">Plants for Sale</h2>
                <h3 className="home__plant-types__sub-heading">From indoors to outdoors, we have the right plnats to suit your needs.</h3>
            ...
            <div className="home__plant-types__right-column">
